 ...
 */
async function getFileSlug(tmdbId, season, episode, type = 'series', userAgent = CONFIG.userAgent) {
    let url;
    let referer;
 ...
 */
async function getEmbedData(fileSlug, userAgent = CONFIG.userAgent) {
